 ...
 *
 * */
ColorThief.prototype.getColor = function(image, quality) {
    var palette       = this.getPalette(image, 5, quality);
 ...
 *
 */
ColorThief.prototype.getPalette = function(pixels, colorCount, quality) {
    ...
    var cmap    = quantize(pixelArray, colorCount);//MMCQ.quantize(pixelArray, colorCount);
...
},{"quantize":1}],3:[function(require,module,exports){
/*
...
Vibrant = (function() {
  ...
  function Vibrant(pixels, colorCount, quality) {
    this.swatches = bind(this.swatches, this);
    var a, allPixels, b, cmap, g, i, offset, pixelCount, pixels, r;
    if (typeof colorCount === 'undefined') {
      colorCount = 64;
    }
