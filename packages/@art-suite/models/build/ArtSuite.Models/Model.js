...
(function() {
  var BaseObject, ErrorWithInfo, InstanceFunctionBindingMixin, Model, ModelRegistry, Promise, compactFlatten, decapitalize, defineModule, failure, formattedInspect, isFailure, isPlainObject, isString, log, merge, missing, modelStore, pending, ref, ref1, success, validStatus,
  ...
  defineModule(module, Model = (function(superClass) {
    ...
    Model.prototype.modelStoreEntryUpdated = function(entry) {};

    Model.prototype.modelStoreEntryAdded = function(entry) {};
