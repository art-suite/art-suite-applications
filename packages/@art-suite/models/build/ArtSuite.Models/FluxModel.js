...
(function() {
  var BaseObject, ErrorWithInfo, FluxModel, InstanceFunctionBindingMixin, ModelRegistry, Promise, compactFlatten, decapitalize, defineModule, failure, fluxStore, formattedInspect, globalCount, isFailure, isPlainObject, isString, isoDateRegexp, log, merge, missing, pending, ref, ref1, success, time, validStatus,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty,
    slice = [].slice;

  ref = require("art-standard-lib"), log = ref.log, decapitalize = ref.decapitalize, merge = ref.merge, isString = ref.isString, isoDateRegexp = ref.isoDateRegexp, time = ref.time, globalCount = ref.globalCount, compactFlatten = ref.compactFlatten, Promise = ref.Promise, formattedInspect = ref.formattedInspect, isPlainObject = ref.isPlainObject, ErrorWithInfo = ref.ErrorWithInfo, defineModule = ref.defineModule;
