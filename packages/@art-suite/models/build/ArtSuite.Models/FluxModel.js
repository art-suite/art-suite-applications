...
(function() {
  var BaseObject, ErrorWithInfo, FluxModel, InstanceFunctionBindingMixin, ModelRegistry, Promise, compactFlatten, decapitalize, defineModule, failure, formattedInspect, isFailure, isPlainObject, isString, log, merge, missing, pending, ref, ref1, store, success, validStatus,
  ...
  defineModule(module, FluxModel = (function(superClass) {
    ...
    FluxModel.prototype.storeGet = function(key) {
      return store.get(this._name, this.toKeyString(key));
    };

    FluxModel.prototype.updateStore = function(key, fluxRecord) {
    ...
    FluxModel.prototype.storeEntryUpdated = function(entry) {};

    FluxModel.prototype.storeEntryAdded = function(entry) {};

    FluxModel.prototype.storeEntryRemoved = function(entry) {};
