...
(function() {
  var ArtModelRegistry, artModelStore, defineModule, isFailure, isFunction, isPlainObject, isString, log, ref, ref1, rubyTrue, success,
  ...
  defineModule(module, function() {
    return function(superClass) {
      var ArtModelSubscriptionsMixin;
      return ArtModelSubscriptionsMixin = (function(superClass1) {
        var _getRetryNow;

        extend(ArtModelSubscriptionsMixin, superClass1);

        function ArtModelSubscriptionsMixin() {
          ArtModelSubscriptionsMixin.__super__.constructor.apply(this, arguments);
          this._subscriptions = {};
        }

        ArtModelSubscriptionsMixin.getter({
          models: function() {
        ...
        ArtModelSubscriptionsMixin.prototype.subscribe = function(subscriptionKey, modelName, key, options) {
          ...
          return this._setStateFromModelRecord(stateField, artModelStore.subscribe(modelName, modelKey, subscriptionFunction, initialModelRecord), initialModelRecord, key);
        };
        ...
        ArtModelSubscriptionsMixin.prototype.subscribeOnModelRegistered = function(subscriptionKeyOrOptions, modelName, modelKey, options) {
          if (isPlainObject(subscriptionKeyOrOptions)) {
            modelName = subscriptionKeyOrOptions.modelName;
          }
          return ArtModelRegistry.onModelRegistered(modelName).then((function(_this) {
            return function() {
        ...
        ArtModelSubscriptionsMixin.prototype.unsubscribe = function(subscriptionKey) {
        ...
        ArtModelSubscriptionsMixin.prototype.unsubscribeAll = function() {
        ...
        _getRetryNow = function(modelName, key) {
          return function() {
            return artModelStore._getEntry(modelName, key).reload();
          };
        };

        ArtModelSubscriptionsMixin.prototype._setStateFromModelRecord = function(stateField, modelRecord, initialModelRecord, key) {
        ...
        return ArtModelSubscriptionsMixin;
...
//# sourceMappingURL=ArtModelSubscriptionsMixin.js.map
