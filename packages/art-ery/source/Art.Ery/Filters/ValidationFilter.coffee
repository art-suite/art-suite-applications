...
###
TODO!!!
# BUG: ValidationFilter doesn't validated the TimestampFilter's fields! (when using addDatabaseFilters)
...
# addDatabaseFilters needs to change order: it needs to run ValidationFilter last.
