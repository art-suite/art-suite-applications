...
(function() {
  ...
  defineModule(module, function() {
    return function(superClass) {
      var KeyFieldsMixinCoffee;
      return KeyFieldsMixinCoffee = (function(superClass1) {
        var defaultKeyFieldsString, keyFields;

        extend(KeyFieldsMixinCoffee, superClass1);

        function KeyFieldsMixinCoffee() {
          return KeyFieldsMixinCoffee.__super__.constructor.apply(this, arguments);
        }

        KeyFieldsMixinCoffee.getKeyFields = function() {
          return this._keyFields;
        };

        KeyFieldsMixinCoffee.getKeyFieldsString = function() {
          return this._keyFieldsString;
        };

        KeyFieldsMixinCoffee.primaryKey = keyFields = function(a) {
          if (isString(a)) {
        ...
        KeyFieldsMixinCoffee.keyFields = keyFields;

        KeyFieldsMixinCoffee.getter({
        ...
        KeyFieldsMixinCoffee.prototype.allKeyFieldsPresent = function(data) {
        ...
        KeyFieldsMixinCoffee.prototype.isRecord = function(data) {
          return isPlainObject(data) && this.allKeyFieldsPresent(data);
        };

        KeyFieldsMixinCoffee.prototype.dataToKeyString = function(a) {
          this.validateKey(a);
        ...
        KeyFieldsMixinCoffee.prototype.createPropsToKeyFunction = function(keyField) {
        ...
        KeyFieldsMixinCoffee.prototype.toKeyObject = function(a) {
        ...
        KeyFieldsMixinCoffee.prototype.dataWithoutKeyFields = function(data) {
        ...
        KeyFieldsMixinCoffee.prototype.validateKey = function(key) {
        ...
        KeyFieldsMixinCoffee._keyFieldsString = defaultKeyFieldsString = "id";

        KeyFieldsMixinCoffee._keyFields = [defaultKeyFieldsString];

        KeyFieldsMixinCoffee._initFields = function() {
          var fields;
          KeyFieldsMixinCoffee.__super__.constructor._initFields.apply(this, arguments);
...
//# sourceMappingURL=KeyFieldsMixinCoffee.js.map
