...
(function() {
  ...
  defineModule(module, Filter = (function(superClass) {
    ...
    Filter.prototype.processBefore = function(request) {
      return this.applyHandler(request, this.getBeforeFilter(request), "beforeFilter");
    };

    Filter.prototype.processAfter = function(request) {
      return this.applyHandler(request, this.getAfterFilter(request), "afterFilter");
    };
      ...
      return this.processBefore(request).then((function(_this) {
        return function(request) {
          ...
          if (request.isResponse) {
            ...
            return ((nextHandler = filterChain[nextIndex = currentFilterChainIndex + 1]) ? nextHandler.handleRequest(request, filterChain, nextIndex) : request.failure("INTERNAL-ERROR: no nextHandler in for request type: " + request.type)).then(function(response) {
