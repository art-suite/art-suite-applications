...
(function() {
  ...
  createDoDynamoQuery = require("./Queries").createDoDynamoQuery;
      ...
      fn = (function(_this) {
        return function(queryModelName, indexKey) {
          ...
          if (isString(indexKey)) {
            ...
            doDynamoQuery = createDoDynamoQuery({
              hashKey: hashKey,
              sortKey: sortKey,
              indexName: indexName,
