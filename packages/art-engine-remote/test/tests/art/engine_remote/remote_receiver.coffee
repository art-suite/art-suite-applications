  ...
  suite "Art.EngineRemote.RemoteReceiver", ->
    ...
    test 'applyUpdates - update an element', (done) ->
      ...
      Element.onNextReady ->
        ...
        remoteReceiver.applyUpdates null, [["update", elementRemoteId, name: newElementName = "myNewName"]]
    ...
    test 'applyUpdates - create a small AIM tree then release child', (done) ->
      ...
      CanvasElement.onNextReady ->
        ...
        remoteReceiver.applyUpdates null, [["update", parentId, children: []]]
    ...
    test 'applyUpdates - resetProps', (done) ->
      ...
      CanvasElement.onNextReady ->
        ...
        remoteReceiver.applyUpdates null, [["update", elementId, null, ["childrenAlignment"]]]
        CanvasElement.onNextReady ->
